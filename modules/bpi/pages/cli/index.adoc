...
[example]
To obtain the export tool, contact a sales representative using this form: https://www.ofelia.com/contact-us[contact us]
...
You can retrieve a license by logging into your Bonita Process Insights instance and accessing the xref:application.adoc#generate-license["Generate license" feature].
...
For more details, see xref:cli/configuration-for-anonymization.adoc[Configure the anonymization].
