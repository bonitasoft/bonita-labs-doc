...
Download BICI from the https://customer.bonitasoft.com/[Bonitasoft Customer Portal].

== Install

Follow the instructions described in the xref:installation_guide.adoc[installation guide].
