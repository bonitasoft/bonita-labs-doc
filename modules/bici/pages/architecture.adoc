...
NOTE: this is an xref:#yolo[Invalid ref]

IMPORTANT: this is another link:https://documentation.bonitasof.com forbidden reference!

NOTE: welcome to "Bonita BPM"

== Partials

This paragraph contains an included partial
