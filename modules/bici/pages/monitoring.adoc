...
image::images/la/monitoring_home_on_time.png[BICI LA Monitoring]
...
image::images/la/monitoring_case_execution_details.png[BICI LA Monitoring Case Details]
...
image::images/la/monitoring_analytics_case_indicators.png[BICI LA Monitoring Case Indicators]
...
image::images/la/monitoring_analytics_task_indicators.png[BICI LA Monitoring Task Indicators]
